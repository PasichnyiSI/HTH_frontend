export const fetchWishlist = async (axiosInstance, setWishlist, setError, setLoading) => {
    try {
        const response = await axiosInstance.get("http://127.0.0.1:8000/wishlist/wishlist/");
...
export const addToWishlist = async (axiosInstance, product, discountedPrice) => {
    try {
      const response = await axiosInstance.post("http://127.0.0.1:8000/wishlist/wishlist/add_item/", {
