export const fetchComparisonlist = async (axiosInstance, setComparisonlist, setError, setLoading) => {
    try {
        const response = await axiosInstance.get("http://127.0.0.1:8000/comparisonlist/comparisonlist/");
...
export const addToComparisonlist = async (axiosInstance, product, discountedPrice) => {
    try {
      const response = await axiosInstance.post("http://127.0.0.1:8000/comparisonlist/comparisonlist/add_item/", {
